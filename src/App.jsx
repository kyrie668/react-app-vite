    ...
    return (
        <AppContext.Provider value={{ appState: { isMobile, curWidth }, appDispatch: dispatch }}>
            <div className="page-layout">
                <div
                    className="router-memu"
                    style={{ padding: isMobile ? '10px 10px' : '0px 120px' }}
                >
                    <RouterMenu>
                        <div className="left-menu">
                            <div className="logo" style={{ backgroundImage: `url(${Logo})` }}></div>
                            <div
                                className="menu-btn-list"
                ...
                <div className="router-outlet">
                    <div
                        className="router-outlet-router"
                        style={{ padding: isMobile ? '10px 10px' : '0px 120px' }}
                    >
                        {outlet}
                    </div>
                    <div
                        className="router-outlet-footer"
                        style={{ padding: isMobile ? '10px 10px' : '50px 50px' }}
                    >
                        ...
                        <div className="outlet-footer-other">
