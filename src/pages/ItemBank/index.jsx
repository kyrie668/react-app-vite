...
import { debounce, get, post } from "../../utils";
...
function Study() {
  ...
  const getListData = (params) => {
    post("/v1/sorting", params)
      .then((res) => {
        dispatch({
          dataSource: res?.content?.questions ?? [],
          list_tatal: res?.content?.total_count ?? 0,
        });
        // dispatch({ labelList });
      })
      .catch((err) => {
